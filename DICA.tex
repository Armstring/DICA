...
To prove that $\bY_t$ weakly converge to $\bY$, by Cram\'{e}r-Wold Theorem we only need to prove for any $m$-dimension vector $\alpha = (\alpha_1,\ldots,\alpha_m)$, $\alpha\bY_t$ weakly converge to $\alpha\bY$.
Note that again by Cram\'{e}r-Wold Theorem,
\[
