...
\begin{thm}
\label{thm:CorofICA}
Let $f_1,\ldots,f_d$ be mutually independent real-valued, \todoc{We always have real-valued functions, right? So maybe mention this always or nowhere} ergodic functions and let $f = (f_1,\ldots,f_d)$.
...
The proof of  \cref{thm:CorofICA} follows immediately from this result:
