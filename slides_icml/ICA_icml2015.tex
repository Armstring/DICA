...
\uncover<+->{For $x\sim \mu=\mu_1\otimes \dots \otimes \mu_d$,
$\eta \in \R^d$, let 
\vspace*{-0.15in}
\[
...
\item[\ds] Why does coherence help?
...
Code: \url{https://github.com/Armstring/Deterministic-ICA}
