...
In particular, the difference in the estimation of the Hessian matrix caused by the noise is $\poly{L_{\eta}, L, d, \sigma_{\max}(A), C}\left(g(T)+1\right)g(T)$. Denote this quantity by $P(L_{\eta})$. 
...
\vspace{-2mm}
\[
\| c_k\hat{A}_{\pi(k)} - A_k\|_2 \le \frac{4\sigma^2_{\max}(A)}{\gamma_R\sigma_{\min}(A)}\tilde{Q},
\]
