...
\item The modified version of  DICA  (DICA\_Mod), and its recursive version (DICA\_Mod\_recur);
\item The default FastICA algorithm in the 'ITE' toolbox \citep{szabo12separation} (FICA); 
\item the recursive Fourier PCA algorithm posted by \citet{xiao2014FPCAPackage} (FPCA);
