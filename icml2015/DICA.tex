...
\]
where $\hat{A}$ is the output of the DICA algorithm and $\tilde{Q}$ is polinomial in the usual problem parameters and decays roughly as $(\xi + P(L_u))$. This is proved in the full version \citep{HuGySz15}. %Theorem~\ref{thm:Modefficiency} in the appendix.
