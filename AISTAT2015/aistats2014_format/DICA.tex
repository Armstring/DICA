...
A detailed discussion of the validness of these conditions is postponed to Section \ref{subsec:validnessCond}. \qed
\end{remark}
...
\end{lemma}
\begin{remark}
Note that all the constants in Lemma \ref{lem:ConstantProb} are polynomial in $d$(or $d^{-1}$ for the lower bound), thus the result of Theorem \ref{thm:Modefficiency} is polynomial in $d$ with at probability at $1/20$. \qed
\end{remark}
\subsection{Validness of the conditions in Theorem \ref{thm:Modefficiency}}
 \label{subsec:validnessCond}
