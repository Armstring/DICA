...
Note that all assumptions about $\epsilon$ will be satisfied by i.i.d Gaussian noise, as proved later in Theorem \ref{thm:finalRes}.
\end{remark}
...
Similarly, we will prove that this assumption does not lose any generality to the traditional stochastic setting of the ICA model with Gaussian noise independent to the source signals, in Theorem \ref{thm:finalRes}. 
