...
\]
where $\hat{A}$ is the output of the DICA algorithm. This is proved in Theorem~\ref{thm:Modefficiency} in the appendix.
This is very similar to the result of Theorem~\ref{thm:efficiency}, with $\gamma_R$ in place of $\gamma_A$, as required.
%\begin{remark}
