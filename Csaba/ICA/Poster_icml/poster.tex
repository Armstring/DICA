...
%------------------------------------------------------------------------------
	...
	\begin{column} {.24\textwidth}
		\begin{block}{Result}
			There exists a method to estimate $A$ from
                        $x(t)=A s(t)+\epsilon(t)$, $t=1,\dots,T,$ such that
			\begin{itemize}
				...
				\end{itemize}
				\item Here $g(T)$ is a function of $D_4(\nu_T^{(s)},\mu)$. In the classical stochastic setting, $g(T) = O(\frac{1}{\sqrt{T}})$.
			\end{itemize}
		\end{block}
		\vspace{0.5ex}
