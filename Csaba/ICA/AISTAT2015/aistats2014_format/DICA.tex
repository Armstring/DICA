...
Given a large enough $T$ (polynomial in $\{L_u, C, \sigma_{\max}(A), L\}$), assume that there exist a product measure $\mu$ such that $\xi$ is small enough polynomial in $\{\gamma_A, 1/d, 1/L_u, 1/\sigma_{\max}(A), \sigma_{\min}(A), 1/\kappa_{\max}, \kappa_{\min}, \ell\}$. 
\if0
Let 
 \begin{align*}
