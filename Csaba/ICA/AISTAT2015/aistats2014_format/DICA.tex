...
\begin{itemize}
\item The re-sampling version of the HKICA algorithm (HKICA\_Re);
\item The symmetrizing version of the HKICA algorithm (HKICA\_Symm);
\item The re-sampling version of the DICA algorithm (DICA\_Re);
\item The symmetrizing version of the DICA algorithm (DICA\_Symm);
...
We will discuss the intuition of the last algorithm later. 
