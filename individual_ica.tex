...
\end{proof}
\todoc[inline]{Warning: What follows is a mixture of a sketch and a wishlist. None of the ``results'' should be taken as proved.
Also, this was written before the previous proposition. It may be that it is only the above proposition what is needed.
}
